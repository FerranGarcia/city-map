function varargout = new_POI(varargin)
% NEW_POI MATLAB code for new_POI.fig
%      NEW_POI, by itself, creates a new NEW_POI or raises the existing
%      singleton*.
%
%      H = NEW_POI returns the handle to a new NEW_POI or the handle to
%      the existing singleton*.
%
%      NEW_POI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NEW_POI.M with the given input arguments.
%
%      NEW_POI('Property','Value',...) creates a new NEW_POI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before new_POI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to new_POI_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @new_POI_OpeningFcn, ...
                   'gui_OutputFcn',  @new_POI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before new_POI is made visible.
function new_POI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to new_POI (see VARARGIN)

% Choose default command line output for new_POI
...
% UIWAIT makes new_POI wait for user response (see UIRESUME)
% uiwait(handles.figure2);


% --- Outputs from this function are returned to the command line.
function varargout = new_POI_OutputFcn(hObject, eventdata, handles) 
